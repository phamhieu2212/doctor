...
class QuickbloxController extends Controller
{
    ...
    public function updateUser($idQuick,$name)
    {
        ...
        curl_setopt($ch, CURLOPT_URL, QB_API_USER_UPDATE);
        curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
    ...
    public function deleteUser($idQuick)
    {
        $dataToken = json_decode($this->getTokenAuth(),true);
        $token = $dataToken['session']['token'];

        // Quickblox endpoints
        DEFINE('QB_API_USER_DELETE', "https://api.quickblox.com/users/".$idQuick.".json");
...
// Generated by curl-to-PHP: http://incarnate.github.io/curl-to-php/
        ...
        curl_setopt($ch, CURLOPT_URL, QB_API_USER_DELETE);
        curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
