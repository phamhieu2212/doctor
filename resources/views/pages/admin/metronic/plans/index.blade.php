            ...
            <div class="m-portlet__head-tools">
                <ul class="m-portlet__nav">
                    <li class="m-portlet__nav-item">
                        <a href="{!! action('Admin\PlanController@create') !!}" class="btn m-btn--pill m-btn--air btn-outline-success btn-sm">
                            <span>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-6">
                        <div id="m_table_1_filter" class="dataTables_filter">
                            <form method="get" accept-charset="utf-8" action="{!! action('Admin\PlanController@index') !!}">
                                {!! csrf_field() !!}
                            ...
                            <thead>
                                <tr>
                                    <th style="width: 10px">{!! \PaginationHelper::sort('id', 'ID') !!}</th>
                                                                                                                                                                                                                                                                                                                                                                                <th>{!! \PaginationHelper::sort('price', trans('admin.pages.plans.columns.price')) !!}</th>
                                                                                                                    <th>{!! \PaginationHelper::sort('status', trans('admin.pages.plans.columns.status')) !!}</th>
                                                                                                                    <th>{!! \PaginationHelper::sort('started_at', trans('admin.pages.plans.columns.started_at')) !!}</th>
                                                                                                                    <th>{!! \PaginationHelper::sort('ended_at', trans('admin.pages.plans.columns.ended_at')) !!}</th>
                                ...
                                @foreach( $plans as $plan )
                                    <tr>
                                        <td>{{ $plan->id }}</td>
                                                                                                                            ...
                                                                                                                            <td>{{ $plan->ended_at }}</td>
                                                                                <td>
                                            <a href="{!! action('Admin\PlanController@show', $plan->id) !!}" class="btn m--font-primary m-btn--pill m-btn--air no-padding">
                                                <i class="la la-edit"></i>
                                            </a>
                                            <a href="javascript:;" data-delete-url="{!! action('Admin\PlanController@destroy', $plan->id) !!}" class="btn m--font-danger m-btn--pill m-btn--air no-padding delete-button">
