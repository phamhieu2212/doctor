            ...
            <div class="m-portlet__head-tools">
                <ul class="m-portlet__nav">
                    <li class="m-portlet__nav-item">
                        <a href="{!! action('Admin\HospitalController@create') !!}" class="btn m-btn--pill m-btn--air btn-outline-success btn-sm">
                            <span>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-6">
                        <div id="m_table_1_filter" class="dataTables_filter">
                            <form method="get" accept-charset="utf-8" action="{!! action('Admin\HospitalController@index') !!}">
                                {!! csrf_field() !!}
                        ...
                        <table class="table table-striped- table-bordered table-hover table-checkable" id="index-table">
                            <thead>
                                <tr>
                                    ...
                                    <th>{!! \PaginationHelper::sort('phone', 'SĐT') !!}</th>
                            ...
                            <tbody>
                                @foreach( $hospitals as $hospital )
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{!! action('Admin\HospitalController@show', $hospital->id) !!}" class="btn m--font-primary m-btn--pill m-btn--air no-padding">
                                                <i class="la la-edit"></i>
                                            </a>
                                            <a href="javascript:;" data-delete-url="{!! action('Admin\HospitalController@destroy', $hospital->id) !!}" class="btn m--font-danger m-btn--pill m-btn--air no-padding delete-button">
